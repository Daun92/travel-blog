...
5. **주의사항**:
   ...
   - ⚠️ **키워드 스터핑 금지**: 키워드를 기계적으로 반복하지 마세요. 전시회명이나 섹션 제목에 주제 키워드를 억지로 결합하지 마세요 (예: "제주도 카페 관련 전시회" ← 이런 식의 제목 금지).
...
5. **주의사항**:
   ...
   - 사진 위치 표시: ![설명](이미지URL)
   - ⚠️ **날조 금지**: 수집 데이터에 미술관·공연장이 포함되어 있더라도, 해당 장소에서 주제와 관련된 특별 전시/행사가 열린다고 **절대 가정하지 마세요**. 전시명, 기간, 가격을 직접 만들어내지 마세요. 수집 데이터에 명시된 전시/행사 정보만 사용하세요.
   - ⚠️ **키워드 스터핑 금지**: 키워드를 기계적으로 반복하지 마세요. 전시회명이나 섹션 제목에 주제 키워드를 억지로 결합하지 마세요 (예: "전통주 양조장 탐방 관련 전시회" ← 이런 식의 제목 금지).

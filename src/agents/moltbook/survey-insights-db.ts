...
/** topicId → discovery 키워드 매핑 (3차 서베이: 독립서점+인디음악 심화) */
const TOPIC_KEYWORD_MAP: Record<number, string[]> = {
  1: ['독립서점', '동네서점', '서점지도', '숨은서점', '책방'],
  2: ['북카페', '카공', '작업카페', '독서카페', '책카페'],
  3: ['서점주인', '큐레이션', '서점인터뷰', '책방주인'],
  4: ['독립출판', '진', 'zine', '소량출판', '독립출판물'],
  5: ['소극장', '라이브바', '라이브클럽', '인디공연', '인디씬'],
  6: ['페스티벌', '버스킹', '인디페스', '음악축제', '거리공연'],
  7: ['인디뮤지션', '인디밴드', '플레이리스트', '인디음악'],
  8: ['공연장', '좌석', '음향', '접근성', '공연장비교']
};
